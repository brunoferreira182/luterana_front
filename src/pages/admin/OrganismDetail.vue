...
<<<<<<< HEAD
    ...
    removeFormation (fieldIndex, iValue) {
      this
        .organismData
        .fields[fieldIndex]
        .value
    ...
    editFormation (fieldIndex, field, value, iValue) {
    ...
    editBankData (fieldIndex,value, iValue) {
    ...
    verifyIfUserHasDocument () {
      ...
      let tabWithDoc
      let fieldWithDoc
      this.organismData.fields.forEach((userField, iField) => {
    ...
    removeBankData (fieldIndex, tabsIndex, iValue) {
      this
        .organismData
        .fields[fieldIndex]
        .value
    ...
    removeThisPerson(fieldIndex, personIndex) {
      this.organismData.fields[fieldIndex].value.splice(personIndex, 1);
    ...
    clkAddMaritalStatus (fieldIndex) {
    ...
    removeThisOrganism(fieldIndex, organismIndex) {
      this.organismData.fields[fieldIndex].value.splice(organismIndex, 1)
